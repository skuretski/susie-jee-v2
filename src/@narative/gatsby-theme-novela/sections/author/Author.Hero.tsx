...
const AuthorHero: React.FC<AuthorHeroProps> = ({ author }) => {
  return (
    <Hero>
      ...
      <Subheading>
        I am currently working as a software engineer and in graduate school at the University of Illinois Urbana - 
        Champaign for computer science, focusing on data science and machine learning. I had a past life as an intensive care nurse 
        where I pushed a good amount of epinephrine and witnessed some truly amazing things. I also love to 
        mentor and support underrepresented groups in tech. 
